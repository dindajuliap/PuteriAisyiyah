						...
						<div class="card-body">
							<div class="row mt-3">
								<div class="col-lg-6">
									...
									<input type="text" name="nama_user" id="nama_user" value="<?= $val->nama_user ?>" class="form-control" style="border-radius: 10px; padding: 20px 22px; color: #7E7E7E; background: #ECECEC; width: 97%" readonly>
								...
								<div class="col-lg-6">
									...
									<input type="text" name="nomorhp_user" id="nomorhp_user" value="<?= $val->nomorhp_user ?>" class="form-control" style="border-radius: 10px; padding: 20px 22px; color: #7E7E7E; background: #ECECEC; width: 97%; margin-left: 3%" readonly>
									...
									<?php if($val->status_user == 'Terdaftar') : ?>
										...
										<div class="row mt-5">
											<div class="col-lg-6">
												<button type="submit" class="btn btn-danger" data-toggle="modal" data-target="#hapusModal<?= $val->id_user ?>" style="border-radius: 10px; width: 25%; float: right; margin-right: 3%">Hapus Data</button>
											</div>
