    ...
    <div class="row">
      <div class="col-12">
        <div class="card" style="padding: 2%">
          <h1 class="mt-1" style="text-align: center; color: #030153"><b>DAFTAR AKUN</b></h1>
	          ...
	          <div class="col-lg-6">
							<form action="" method="post" style="width: 45%; margin-left: 53%; margin-top: 1%">
								<div class="input-group">
								  <input type="text" name="search" class="form-control" placeholder="Cari data akun" autocomplete="off">
                  ...
                  <tr height="50px">
                    ...
                    <?php else : ?>
                      <td style="text-align: center">
                        <a href="<?= site_url('Admin/DetailDataAkun/'.$val->id_user)?>" class="btn btn-success btn-sm">
