	...
	<div style="width: 40%; margin: auto; text-align: center; padding: 40px 0px">
      ...
      <div class="col-lg-6">
	        ...
	        <input type="text" name="tmpt_lahir_user" id="tmpt_lahir_user" value="<?= $tabel_akun['tmpt_lahir_user'] ?>" class="form-control" style="border-radius: 10px; padding: 20px 22px; color: #7E7E7E; background: #ECECEC;">
					<small class="form-text text-danger" align="left" style="margin-left: 32%; margin-top: 9%"><?= form_error('tmpt_lahir_user') ?></small>
				</div>
				<div style="padding-top: 20px;">
	        ...
	        <input type="date" name="tgl_lahir_user" id="tgl_lahir_user" value="<?= $tabel_akun['tgl_lahir_user'] ?>" class="form-control" style="border-radius: 10px; padding: 20px 22px; color: #7E7E7E; background: #ECECEC;">
					<small class="form-text text-danger" align="left" style="margin-left: 32%; margin-top: 9%"><?= form_error('tgl_lahir_user') ?></small>
				</div>
				<div style="padding-top: 20px;">
					...
					<small class="form-text text-danger" align="left" style="margin-left: 32%; margin-top: 9%"><?= form_error('nomorhp_user') ?></small>
				</div>
			</div>
			...
			<div class="col-lg-6">
				<div style="padding-top: 30px;">
					...
					<small class="form-text text-danger" align="left" style="margin-left: 32%; margin-top: 9%"><?= form_error('jk_user') ?></small>
				</div>
				<div style="padding-top: 20px;">
					...
					<small class="form-text text-danger" align="left" style="margin-left: 32%; margin-top: 9%"><?= form_error('email_user') ?></small>
				</div>
			<div style="padding-top: 20px;">
	    	<h6 style="color: #030153; text-align: left;"><b>Alamat</b></h6>
				...
				<small class="form-text text-danger" align="left" style="margin-left: 32%; margin-top: 9%"><?= form_error('alamat_user') ?></small>
			</div>
		</div>

		<div>
			<button type="submit"  class="btn" style="border-radius: 10px; width: 45%; height: 46px; margin: 50px 0px; margin-left: 10px; padding-top: 10px; float: right; background: #030153; color: white">Simpan</button>
			<a href="<?= base_url('Admin/DaftarAkun') ?>" class="btn" style="border-radius: 10px; width: 45%; height: 46px; margin: 50px 0px; padding-top: 10px; float: right; background: grey; color: white">Batal</a>
		</div>
