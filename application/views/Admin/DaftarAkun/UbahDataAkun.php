		...
		<form action="" method="post">
			<div class="row">
				<div class="col-lg-6">
					...
					<label class="mt-1">Nomor Handphone</label>
				...
				<div class="col-lg-6">
					<label style="margin-left: 3%">Nama Lengkap</label>
					...
					<label style="margin-left: 3%" class="mt-1">Tempat Lahir</label>
					...
					<label style="margin-left: 3%" class="mt-1">Tanggal Lahir</label>
