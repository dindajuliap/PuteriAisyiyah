	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="col-lg-12" style="width: 90%; margin: 3% 5% 4% 5%">
			<div class="row">
				...
				<div class="col-lg-6 mt-2">
          <label style="margin-left: 8%;">Sampul Berita</label><br>
					<input type="file" id="cover_berita" name="cover_berita" style="margin-left: 8%;">
        </div>
        ...
        <div class="col-lg-6 mt-4">
          ...
          <small class="form-text text-danger"><?= form_error('isi_berita') ?></small>
				...
				<div class="col-lg-6 mt-4">
					<input type="hidden" name="tanggal_berita" id="tanggal_berita" value="<?= date("d-m-y"); ?>" class="form-control" style="border-radius: 10px; padding: 20px 22px; color: #7E7E7E; background: #ECECEC; width: 92%; float: right;">
