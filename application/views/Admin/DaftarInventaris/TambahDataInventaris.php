		...
		<form action="" method="post" enctype="multipart/form-data">
			<div class="row mt-3">
				<div class="col-lg-12 d-md-block">
					...
					<input type="text" autocomplete="off" name="nama_inventaris" id="nama_inventaris" value="<?= set_value('nama_inventaris') ?>" class="form-control" style="border-radius: 10px; padding: 20px 22px; color: #7E7E7E; background: #ECECEC; width: 50%; margin-left: 25%">
					...
					<input type="number" min="1" max="10" name="letak_inventaris" id="letak_inventaris" value="<?= set_value('letak_inventaris') ?>" class="form-control" style="border-radius: 10px; padding: 20px 22px; color: #7E7E7E; background: #ECECEC; width: 50%; margin-left: 25%">
					...
					<input type="number" min="1" max="999" name="jumlah_inventaris" id="jumlah_inventaris" value="<?= set_value('jumlah_inventaris') ?>" class="form-control" style="border-radius: 10px; padding: 20px 22px; color: #7E7E7E; background: #ECECEC; width: 50%; margin-left: 25%">
