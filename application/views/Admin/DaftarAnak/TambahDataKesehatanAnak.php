		...
		<form action="" method="post">
			<div class="row mt-3">
				<div class="col-lg-6">
					...
					<input type="number" max="999" min="1" maxlength="3" name="bb_anak" id="bb_anak" class="form-control" style="border-radius: 10px; padding: 20px 22px; color: #7E7E7E; background: #ECECEC; width: 97%">
					<small class="form-text text-danger"><?= form_error('bb_anak') ?></small>

          <label>Tinggi Badan</label>
					<input type="number" max="999" min="1" maxlength="3" name="tb_anak" id="tb_anak" class="form-control" style="border-radius: 10px; padding: 20px 22px; color: #7E7E7E; background: #ECECEC; width: 97%">
          ...
          <label style="margin-left: 3%">Penyakit Bawaan Anak</label>
					<textarea name="penyakit_bawaan" id="penyakit_bawaan"  class="form-control" style="border-radius: 10px; padding: 13px 20px; color: #7E7E7E; background: #ECECEC; width: 97%; height: 127px; resize: none; margin-left: 3%"></textarea>
				</div>
			</div>
