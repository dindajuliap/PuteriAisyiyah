		...
		<div class="row">
			<div class="col-12">
				<div class="card" style="padding: 2%;">
					<h1 class="mt-1" style="text-align: center; color: #030153;">Daftar Donasi</h1>
							...
							<table id="example1" class="table table-bordered table-striped">
								...
								<tbody>
									...
									<tr>
										...
										<td style="text-align: center;"><?= $val->tgl_donasi ?></td>
										<td style="text-align: center;"><?= $val->jenis_donasi ?></td>
