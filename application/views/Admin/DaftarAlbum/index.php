    ...
    <div class="row">
      <div class="col-12">
        <div class="card" style="padding: 2%">
          <h1 class="mt-1" style="text-align: center; color: #030153"><b>DAFTAR ALBUM</b></h1>

          <?= $this->session->flashdata('message') ?>

		      <div class="row">
            <div class="col-lg-6">
              <a href="<?= base_url('Admin/DaftarAlbum/TambahAlbum') ?>" style="margin-left: -15%">
	          ...
	          <div class="col-lg-6">
							<form action="" method="post" style="width: 45%; margin-left: 53%; margin-top: 1%">
								<div class="input-group">
								  <input type="text" name="search" class="form-control" placeholder="Cari album" autocomplete="off">
              ...
              <table style="width: 100%; border-style: solid; border-color: #EFEFEF" border="2">
                ...
                <tbody style="height: 50px; background-color: #FAFAFA">
                  ...
                  <tr height="50px">
                    ...
                    <td style="padding: 7px"><?= $val->nama_album ?></td>

										<td style="text-align: center">
										<a href="<?= site_url('Admin/DetailAlbum/'.$val->id_album)?>" class="btn btn-success btn-sm">
                      ...
                      <a class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapusModal<?= $val->id_album ?>" style="color: white" type="submit">
        ...
        <div class="modal-content" style="padding: 20px 30px; border-radius: 20px">
          <div class="modal-body">
            ...
            <h3 class="modal-title mt-3" id="exampleModalLabel" align="center">
              <b style="font-family: Arial; color: #595959">Hapus Album Panti</b>
            </h3>
            ...
            <div class="row">
              <a class="btn btn-primary text-center" href="<?= base_url('Admin/HapusAlbum/') . $val->id_album ?>" style="width: 100px; margin-left: auto; margin-right: 7px; background: #030153; border-color: #030153">Yakin</a>
