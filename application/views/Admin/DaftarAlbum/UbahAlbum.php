		...
		<form action="" method="post" enctype="multipart/form-data">
			<div class="row mt-3">
				<div class="col-lg-12 d-md-block">
					...
					<input type="text" autocomplete="off" value="<?= $album['nama_album'] ?>" name="nama_album" id="nama_album" value="<?= set_value('nama_album') ?>" class="form-control" style="border-radius: 10px; padding: 20px 22px; color: #7E7E7E; background: #ECECEC; width: 50%; margin-left: 25%">
