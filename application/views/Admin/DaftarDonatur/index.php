<body>
    ...
    <div class="row">
      <div class="col-12">
        <div class="card" style="padding: 2%">
          <h1 class="mt-1" style="text-align: center; color: #030153"><b>DAFTAR DONATUR</b></h1>
	          ...
	          <div class="col-lg-6">
							<form action="" method="post" style="width: 45%; margin-left: 53%; margin-top: 1%">
								<div class="input-group">
								  <input type="text" name="search" class="form-control" placeholder="Cari data donatur" autocomplete="off">
                ...
                <tbody style="height: 50px; background-color: #FAFAFA">
                  ...
                  <tr height="50px">
                    ...
                    <td style="text-align: center">
                      <a data-toggle="modal" data-target="#ubahModal<?= $val->id_donatur ?>" class="btn btn-warning btn-sm">
                        <i class="fas fa-edit"></i>
                      </a>

                      <a class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapusModal<?= $val->id_donatur ?>" style="color: white" type="submit">
  ...
  <?php foreach($donatur as $val) : ?>
    <div class="modal fade" id="ubahModal<?= $val->id_donatur ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content" style="padding: 20px 30px; border-radius: 20px">
          <div class="modal-body">
            <h3 class="modal-title mt-3" id="exampleModalLabel" align="center">
              <b style="font-family: Arial; color: #595959">Ubah Data Donatur</b>
            </h3>

            <form action="<?= base_url('Admin/UbahDataDonatur/') . $val->id_donatur ?>" method="post">
              <div class="row mb-4 mt-3">
                <input type="text" autocomplete="off" style="border-radius: 10px; padding: 10px 22px; color: #7E7E7E; background: #ECECEC; border-color: #ECECEC; width: 100%" placeholder="Nama Donatur" value="<?= $val->nama_donatur ?>" name="nama_donatur">
              </div>
    ...
    <div class="modal fade" id="hapusModal<?= $val->id_donatur ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content" style="padding: 20px 30px; border-radius: 20px">
          <div class="modal-body">
            <span>
            ...
            <h3 class="modal-title mt-3" id="exampleModalLabel" align="center">
              <b style="font-family: Arial; color: #595959">Hapus Data Donatur</b>
            </h3>
            ...
            <div class="row">
              <a class="btn btn-primary text-center" href="<?= base_url('Admin/HapusDataDonatur/') . $val->id_donatur ?>" style="width: 100px; margin-left: auto; margin-right: 7px; background: #030153; border-color: #030153">Yakin</a>
              <button type="button" class="btn btn-secondary" data-dismiss="modal" style="width: 100px; margin-right: auto; margin-left: 7px">Batal</button>
            </div>
          </div>
        </div>
