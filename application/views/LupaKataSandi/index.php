  ...
  <form action="" method="post">
    <div class="row" style="margin: 0px; padding: 0px">
      ...
      <div class="col-lg-6" style="margin-left: auto; margin-right: auto" align="center">
        ...
        <input type="text" autocomplete="off" name="email_user" id="email_user" placeholder="Email" class="form-control" style="border-radius: 10px; padding: 22px 20px; color: #7E7E7E; background: #ECECEC; width: 70%">
