...
<body style="font-family: Arial">
  <div class="row" id="body-row">
    ...
    <div class="col-lg-6" style="margin-left: auto; margin-right: auto" align="center">
      <h2 style="color: #030153; margin-left: 15%; margin-top: 19%"align="left">
        <b>Registrasi</b>
      </h2>

      <form action="" method="post">
        <input type="text" name="email_user" id="email_user" placeholder="Email" class="form-control mt-4" style="border-radius: 10px; padding: 22px 20px; color: #7E7E7E; background: #ECECEC; width: 70%">
        ...
        <input type="password" name="konfirmasi_password" id="konfirmasi_password" placeholder="Konfirmasi Kata Sandi" class="form-control mt-3" style="border-radius: 10px; padding: 22px 20px; color: #7E7E7E; background: #ECECEC; width: 70%">
